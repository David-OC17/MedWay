...
def trainAnalyzeState(period:str) -> None:
    ...
    The function pulls the data from the appropiate database, trains the model and exports it to a file.
...
def analyzeState(period:str) -> None:
    ...
    Specify the type of model to use. If the model is not trained, the function will raise an appropiate error.
    '''
